...
function ScheduleDetail({ navigation, route }) {
    ...
    useEffect(() => {
        getProfileDoctorById(doctor._id).then(
        ...
        <KeyboardAvoidingView behavior="position">
            <ScrollView style={styles.container}>
                ...
                <List.Section>
                    ...
                    <List.Item
                        style={styles.profile_specialist}
                        title={`Ngày sinh: ${moment(doctor.person.dob).format(
                            "L"
                        )}`}
                    ...
                    <View>
                        <List.Section>
                            ...
                            {profile.specialist.map((special) => {
                                return (
                                    <List.Item
                                        ...
                                        title={`${special}`}
                                        left={() => (
                                            <List.Icon icon="book-check-outline" />
                                        )}
                                    />
                                );
                            })}
                            ...
                            <List.Item
                                ...
                                left={() => (
                                    <List.Icon icon="application-edit-outline" />
                                )}
                            />
